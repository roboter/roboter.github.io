---
title: 'Read device ID on GigaDevice ARM Processor'
description: 'Some small example how to read DeviceId'
pubDate: '2023-05-12T01:21:47.613Z'
heroImage: '/images/gigadevice-arm.png'
categories: ['gigadevice']
tags: ['gigadevice', 'shield', 'c', 'arduino']
